...
module.exports = {
    ...
    SKILL_QUERY: [
        'SELECT',
            ...
            'coalesce(SkillName.valueInt, SkillName.valueFloat) AS id,',
            'coalesce(SkillLevel.valueInt, SkillLevel.valueFloat) AS requiredLevel,',
            'Skills.description AS description,',
            'coalesce(SkillRank.valueFloat, SkillRank.valueInt) AS rank',
        'FROM',
            'invTypes AS Skills,',
        ...
        'WHERE',
            'Skills.typeID == coalesce(SkillName.valueInt, SkillName.valueFloat)',
            'AND (',
            ...
            ')',
            'AND SkillRank.typeID == coalesce(SkillName.valueInt, SkillName.valueFloat)',
